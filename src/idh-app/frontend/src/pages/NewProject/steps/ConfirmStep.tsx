...
function InfoRow({ label, value }: { label: string; value: string }) {
  return (
    <div style={{ marginBottom: '10px' }}>
      ...
      <div style={{ fontFamily: theme.font.mono, fontSize: theme.fontSize.sm, color: theme.colors.text }}>
        {value}
      </div>
    </div>
  );
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <div>
        ...
        />
        <div style={{ fontSize: theme.fontSize.xs, color: theme.colors.muted, marginTop: '5px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '4px' }}>
        ...
        <button
          ...
          style={{
            padding: '8px 24px',
            background: loading || !groupId.trim() ? theme.colors.surface : theme.colors.accent,
            color: loading || !groupId.trim() ? theme.colors.muted : theme.colors.bg,
            border: 'none',
            borderRadius: theme.radius.md,
